...
function SinglePage() {
  ...
  const handleContactOwner = () => {
    ...
    window.location.href = `mailto:${post.user.email || 'info@OA Realty.com'}?subject=${subject}&body=${body}`;
  };
    ...
    <div className="singlePage">
      ...
      <div className="features">
        <div className="wrapper">
          ...
          {/* Additional CTAs */}
          <div className="propertyCtaSection">
            <h3>Need Help with This Property?</h3>
            <div className="propertyCtaButtons">
              <CtaButton 
                text="Book a Viewing" 
                link="/contact" 
